 ...
 * @author admin
 */
public class frmcheckStatus extends javax.swing.JFrame {

    /**
     * Creates new form frmcheckStatus
     */
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon("D:\\packers and movers\\images\\th (26).jpg")); // NOI18N
    ...
    private void cmdsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdsearchActionPerformed
        ...
        try{
            ...
            while(rs.next()){
             ...
             JOptionPane.showMessageDialog(null,e+"Enter Valid Id Or Record Is Not Present");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmcheckStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmcheckStatus().setVisible(true);
            }
        });
    }
